...
myDiv.style.height = '50vh'
myDiv.style.width = '80vh'
myDiv.style.background = '#ff9933'
myDiv.style.paddingLeft='20px'


const hTag = document.createElement('h1')
hTag.style.color = '#be0027'
hTag.style.fontFamily = 'Arial'
hTag.style.fontSize = '70px'
const hNode = document.createTextNode('Zufälliges Bild mit Javascript anzeigen.')
hTag.appendChild(hNode)
myDiv.appendChild(hTag)

const myBtn = document.createElement('button')
myBtn.style.background = '#fe5000'
...
myBtn.addEventListener('click', () => {
    ...
    const picLink = data[picture].download_url
